...
const columns = [
    ...
    { field: "col3", headerName: "Motivo", width: 100 },
    { field: "col4", headerName: "Tipo de Certificado", width: 100 },
    { field: "col5", headerName: "Semestre", width: 100 },
    { field: "col6", headerName: "Certificado", width: 100 },
    { field: "col7", headerName: "Placa", width: 100 },
    { field: "col8", headerName: "Técnico", width: 100 },
    { field: "col9", headerName: "Línea", width: 100 },
    { field: "col10", headerName: "Observaciones", width: 100 },
    { field: "col11", headerName: "Usuario", width: 300 },
];

function CancelarCertificados() {
                    ...
                    <Grid item xs={12} md={4}>
                        ...
                        >
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={6}>
                                    <MenuSelector
                                        textoTitulo={"Motivo de Cancelación"}
                                        arregloValores={[
                                            {
                                                nombre: "Credito",
                                                valor: 10,
...
export default CancelarCertificados;
